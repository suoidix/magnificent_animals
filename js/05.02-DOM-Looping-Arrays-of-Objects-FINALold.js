...
The interface is a grid of 18 animal thumbnail images at left, and a video player, at right. Info about the animal appears below the video. The first animal, 'American bison' appears on page load.
...
// 15. Save and reload the page; the images should all be there although clicking them doesn't work yet, since we still need to write the `swapAnimal()` function.
